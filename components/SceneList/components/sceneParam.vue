<template>
  <el-row :gutter="20" style="height: calc(100% -)">
    <el-col :span="5">
      <el-card
        class="theme-card"
        :body-style="{ padding: '0 20px', height: 'calc(100% - 39px)' }"
      >
        <div slot="header" class="headerFontSize">指令集</div>
        <el-tree
          class="theme-tree"
          node-key="data.id"
          @children="onChildren"
    ...
    <el-col :span="9">
      <el-card
        ...
        :body-style="{ padding: '0 20px', height: 'calc(100% - 39px)' }"
      >
        <div slot="header" class="headerFontSize">设置参数</div>
        <el-form ref="form" label-width="80px" class="theme-form">
          <el-form-item
          ...
          >
            <el-select
              ...
              value=""
            >
              <el-option label="label" value="接收机1"></el-option>
            </el-select>
          </el-form-item>
          <el-button class="theme-button" type="primary">确定</el-button>
        </el-form>
      </el-card>
    </el-col>
    <el-col :span="10">
      <el-card
        ...
        :body-style="{ padding: '0 20px', height: 'calc(100% - 39px)' }"
      >
        <div slot="header" class="headerFontSize">场景流程</div>
        <reveal
          ref="revealDlg"
          :cmdList="cmdList"
...
<script>
import receiveSatellite from '@/components/SceneList/components/receive-satellite'
import aisleLocation from '@/components/SceneList/components/aisle-location'
import instruct from '@/components/SceneList/components/instruct'
import PPSDelayTime from '@/components/SceneList/components/PPS-delayTime'
import rf from '@/components/SceneList/components/rf'
import workPattern from '@/components/SceneList/components/work-pattern'
import loadHead from '@/components/SceneList/components/load-head'
import loadState from '@/components/SceneList/components/load-state'
import start from '@/components/SceneList/components/start'
import cease from '@/components/SceneList/components/cease'
import wait from '@/components/SceneList/components/wait'
import waitBackValue from '@/components/SceneList/components/waitBackValue'
import reveal from '@/components/SceneList/components/reveal'
